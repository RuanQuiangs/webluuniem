...
namespace webluuniem.Areas.Admin.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Index(string searchString, int? page)
        {
            ...
            var product = _context.Products.OrderBy(x => x.ProductID).ToList();
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                product = product.Where(b => b.ProductName.ToLower().Contains(searchString)).ToList();
        ...
        public ActionResult Create(Product model, HttpPostedFileBase uploadhinh)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                model.Slug = convertToUnSign2(model.ProductName);
        ...
        public ActionResult Edit(Product model, HttpPostedFileBase uploadhinh)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                product.Slug = convertToUnSign2(product.ProductName);
