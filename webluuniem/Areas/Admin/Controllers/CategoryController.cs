...
namespace webluuniem.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public ActionResult Index(string searchString, int? page)
        {
            ...
            var category = _context.Categorys.OrderBy(x => x.CategoryID).ToList();
            ...
            if (!String.IsNullOrEmpty(searchString))
            {
                ...
                category = category.Where(b => b.CategoryName.ToLower().Contains(searchString)).ToList();
                
            }

            return View(category.ToList().ToPagedList(pageNumber, pageSize));
        }
        ...
        public ActionResult Create(Category model, HttpPostedFileBase uploadhinh)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.error = "mô tả không quá 150 kí tự ( Khoảng 30 từ )";
                    return View();
                }
